...
-- VALUES
--     ('act_travel_declare', NULL, '境外行程报备', 'Y', '信用卡风险侦测系统-参数设置-行程报备登记',
...
--     (mapping_id, standard_intent_code, standard_intent_name, action_id,
--      mapping_priority, enabled, created_by, created_name, created_time, updated_by, updated_name, updated_time)
-- VALUES
--     ('m_001', 'INTENT_TRAVEL_DECLARE', '境外行程报备', 'act_travel_declare',
